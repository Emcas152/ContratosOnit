...
class EdificioFormRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'id_condominio.integer' => 'El campo :attribute debe de ser un numero entero',
            'nombre.required' => 'El campo :attribute es obligatorio',
            'descripcion.required' => 'El campo :attribute es obligatorio',
            'niveles.required' => 'El campo :attribute es obligatorio',
            'niveles.integer' => 'El campo :attribute debe de ser un numero entero',
