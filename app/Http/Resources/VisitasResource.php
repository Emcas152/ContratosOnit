...
class VisitasResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        [
            ...
            'apartamento' => $this->visitantes->inquilinoApartamento !== null ? $this->visitantes->inquilinoApartamento ->nombre : '',
            ...
            'nombre_visitante' =>$this->visitantes !== null ? $this->visitantes->nombre_visita : '',
            'dpi_visitante' =>$this->visitantes !== null ? $this->visitantes->dpi_visita : '',
