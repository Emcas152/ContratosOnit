          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: center;">
			            <img src="https://onit.gt/wp-content/uploads/2018/06/ONIT_LOGO-02.png" style="display: inline-block; width: 100px; margin-right: 100px;" alt="">
			          </td>
          		</tr>
          	</table>
          </td>
            	...
            	<tr>
			          <td style="text-align: center;">
			          	<div class="text-author">
                            ...
                            <p><a href="https://lifebackend.swarmdesarrollo.com/storage/{{ $data['file_name_energia'] }}" class="btn btn-primary">Energia</a></p>
                            @endif
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
        <tr>
          <td class="bg_light" style="text-align: center;">
          	<p>COPYRIGHT  © 2023 - ONIT, Todos los derechos reservados.</p>
          </td>
        </tr>
      </table>
