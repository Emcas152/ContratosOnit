...
<body>
    <div class="contenedor">
        ...
        <div class="contenedorTexto">
            ...
            <p class="textoNegrita">Contrato de prestación para servicio de agua @if($apartamento["tipo_proyecto"] == 'VIVO 4') @endif</p>
            <p class="texto">
                ...
                para facturación <span class="negrita">@if ($apartamento["email_facturacion"] == '') 
                    {{ $empresa["email"] }} @else {{ $apartamento["email_facturacion"] }} @endif</span>; en adelante EL CLIENTE, por este medio contrata el servicio de agua que será suministrado por
            ...
            <p class="texto">
                ...
                EL PROVEEDOR medirá el abastecimiento de agua a través de su equipo de medición (medidos, en el punto de entrega designada en una fecha en el rango entre el día 1 y 15 de cada mes). El personal designado por EL PROVEEDOR es el único facultado para instalar, remover, sustituir y ajustar el equipo de medición. El CLIENTE es responsable del equipo de medición y le será cobrado el valor de este, por su destrucción parcial o pérdida del equipo (En modalidad de depósito anticipado). Al CLIENTE le queda prohibido: a) Tomar agua que no haya sido medida; b) Impedir el correcto funcionamiento del equipo de medición; c) Alterar el equipo de medición de cualquier forma; d) Reconectar el servicio por sí mismo o por medio de personas no autorizadas; e) Redistribuir agua a otros inmuebles o ramificar la conexión domiciliar sin autorización y/o utilizar el servicio para otros fines que no sean domésticos o comercializarlos; f) EL PROVEEDOR está facultado a cobrar una multa de hasta diez mil quetzales exactos (Q 10,000.00) en caso el cliente altere de cualquier manera el sistema de medición.
            </p>
            <p class="texto">
        ...
        <div class="contenedorTexto">
            ...
            <p class="texto">
                En la ciudad de Guatemala el día {{ $fecha_texto }}, como NOTARIO DOY FE, que la firma que antecede es autentica por haber sido puesta el día de hoy en mi presencia por <span class="negrita">
                    {{ $empresa["nombre_representacion"] }}</span> quien se identifica con<span class="negrita"> @if ($empresa["tipo_documento"] == 'DPI')
                    DPI
                    @else
                    PASAPORTE
                    @endif
                ...
                @endif
                La firma calza un contrato de servicio de agua. El compareciente, firma nuevamente la presente acta de legalización, junto con el notario autorizante.
            </p>
            <br>
            <br>
            <p class="texto">
