    ...
    <div class="contenedor">
        ...
        <div class="contenedorTexto">
            ...
            <p class="texto">
                ...
                para facturación <span class="negrita">{{ $email }}</span>; en adelante EL CLIENTE, por este medio contrata el servicio de energía eléctrica que será suministrado por  
